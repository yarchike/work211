        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBankCardChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.mBankCardChkBx_name, Toast.LENGTH_LONG).show();
                }
                if (mMobilePhoneChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.mMobilePhoneChkBx_name, Toast.LENGTH_LONG).show();
                }
                if (mCashAddressChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.mCashAddressChkBx_name, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
